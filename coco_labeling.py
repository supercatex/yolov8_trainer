...
# ord('q') = Quit
# ord('0') ~ ord('9') = change class_id
# Mouse Left Double Click = change (train/valid)
# Mouse Middle Click = save
# Mouse Left Down/Move/Up = Rectangle
